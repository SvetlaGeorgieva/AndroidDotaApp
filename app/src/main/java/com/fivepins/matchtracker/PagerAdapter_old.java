...
public class PagerAdapter_old extends FragmentStatePagerAdapter {
    int mNumOfTabs;

    public PagerAdapter_old(FragmentManager fm, int NumOfTabs) {
        super(fm);
...
//        bundleDay1.putString("date", "2016-09-20");
